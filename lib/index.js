...
Stringifier = class Stringifier extends stream.Transform {
  constructor(opts = {}) {
    var base, base1, base2, base3, base4, base5, isRegExp, isString, j, k, len, options, quoted_match, ref, v;
    super({...{
    ...
    if ((base5 = options.cast).nil == null) {
      base5.nil = function(value) {
        return value;
      };
    }
  ...
  __cast(value, context) {
    ...
    try {
      if (type === 'string') {
        ...
        return [void 0, this.options.cast.nil(value, context)];
      } else {
